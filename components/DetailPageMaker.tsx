        ...
        >
          ...
          >
            ...
            <button
              ...
              style={{ width:"100%", padding:"14px", background:"linear-gradient(135deg,#6366F1,#8B5CF6)", border:"none", borderRadius:14, fontSize:15, fontWeight:700, color:"white", cursor:"pointer", display:"flex", alignItems:"center", justifyContent:"center", gap:10, boxShadow:"0 4px 16px rgba(99,102,241,0.3)", marginBottom:12 }}
            >
          ...
          <div style={{ position: "relative" }}>
            {user ? (
              <button
                ...
                style={{ display: "flex", alignItems: "center", gap: 6, padding: "3px 10px 3px 4px", borderRadius: 20, background: showProfileMenu ? "#F3F4F6" : "white", border: "1px solid #E5E7EB", cursor: "pointer", transition: "background 0.15s" }}
              >
                {user.photoURL ? (
                  <img src={user.photoURL} alt="" style={{ width: 24, height: 24, borderRadius: "50%", objectFit: "cover", border: "2px solid rgba(124,58,237,0.25)" }} />
                ) : (
                  <div style={{ width: 24, height: 24, borderRadius: "50%", background: "linear-gradient(135deg,#7C3AED,#EC4899)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 11, fontWeight: 700, color: "white" }}>
                    {(user.displayName || user.email || "?")[0].toUpperCase()}
                  </div>
                )}
                <span style={{ fontSize: 11, fontWeight: 600, color: "#374151", maxWidth: 72, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                  {user.displayName?.split(" ")[0] || user.email?.split("@")[0]}
                </span>
                <svg width="10" height="10" viewBox="0 0 10 10" fill="none" style={{ flexShrink: 0, transition: "transform 0.15s", transform: showProfileMenu ? "rotate(180deg)" : "none" }}>
                  <path d="M2 3.5L5 6.5L8 3.5" stroke="#9CA3AF" strokeWidth="1.5" strokeLinecap="round"/>
                </svg>
              </button>
            ) : (
              <button
                onClick={signIn}
                style={{ display: "flex", alignItems: "center", gap: 6, padding: "5px 12px", borderRadius: 8, background: "white", border: "1px solid #E5E7EB", fontSize: 11, fontWeight: 700, color: "#374151", cursor: "pointer" }}
              >
            ...
            {showProfileMenu && user && (
              <div
                style={{ position: "absolute", right: 0, top: "calc(100% + 6px)", width: 200, background: "white", borderRadius: 14, boxShadow: "0 8px 32px rgba(0,0,0,0.14)", border: "1px solid #E5E7EB", zIndex: 300, overflow: "hidden", animation: "fadeUp 0.15s ease both" }}
              ...
              >
                ...
                <a
                  href="/library"
                  style={{ display: "flex", alignItems: "center", gap: 10, padding: "11px 16px", textDecoration: "none", color: "#374151", fontSize: 12, fontWeight: 600, borderBottom: "1px solid #F3F4F6" }}
                ...
                <button
                  ...
                  style={{ width: "100%", display: "flex", alignItems: "center", gap: 10, padding: "11px 16px", background: "transparent", border: "none", textAlign: "left", color: "#EF4444", fontSize: 12, fontWeight: 600, cursor: "pointer" }}
